...
(marked with a null value in JavaScript, with the default value in COBOL). The value of the question property should 
...
// 	const devsWQuestions = devs.reduce((res, dev) => {
...
// 		return res
// 	}, [])
// 	return missingFound ? devsWQuestions : []
// }

const askForMissingDetails = (devs) => {
	return devs.filter((dev) => {
		return Object.keys(dev).some(
			(key) =>
				!dev[key] && (dev.question = `Hi, could you please provide your ${key}.`)
		)
	})
}
